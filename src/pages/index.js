...
function HeroSection() {
    return (<section className={index_module_css_1.default.hero}>
      <div className={index_module_css_1.default.heroBackground}>
        <div className={index_module_css_1.default.gridPattern}></div>
        <div className={index_module_css_1.default.glowOrb}></div>
        <div className={index_module_css_1.default.glowOrb2}></div>
      </div>
      <div className={index_module_css_1.default.heroContent}>
        <h1 className={index_module_css_1.default.heroTitle}>
          <span className={index_module_css_1.default.titleNam}>Nam</span>
          <span className={index_module_css_1.default.titleWiki}>Wiki</span>
        </h1>
        <p className={index_module_css_1.default.heroTagline}>
          Learn Namada. Protect Your Privacy.
        </p>
        <p className={index_module_css_1.default.heroDescription}>
        ...
        <div className={index_module_css_1.default.heroButtons}>
          <Link_1.default className={index_module_css_1.default.buttonPrimary} to="/docs/getting-started/what-is-namada">
            Start Learning
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
              <path d="M4 10H16M16 10L11 5M16 10L11 15" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </Link_1.default>
          <Link_1.default className={index_module_css_1.default.buttonSecondary} to="/docs/guides/wallets/install-namada-extension">
            Setup Wallet
          </Link_1.default>
        </div>
        <div className={index_module_css_1.default.trustBadges}>
          <div className={index_module_css_1.default.badge}>
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
...
function LearningPathsSection() {
    return (<section className={index_module_css_1.default.learningPaths}>
      <div className={index_module_css_1.default.container}>
        <div className={index_module_css_1.default.sectionHeader}>
          <h2 className={index_module_css_1.default.sectionTitle}>Learning Paths</h2>
          <p className={index_module_css_1.default.sectionSubtitle}>
            Choose your path and learn at your own pace
          </p>
        </div>
        <div className={index_module_css_1.default.pathsGrid}>
          {learningPaths.map(function (path, idx) { return (<Link_1.default key={idx} to={path.link} className={index_module_css_1.default.pathCard}>
              <div className={index_module_css_1.default.pathIcon}>
                <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" d={path.icon}/>
                </svg>
              </div>
              <h3 className={index_module_css_1.default.pathTitle}>{path.title}</h3>
              <p className={index_module_css_1.default.pathDescription}>{path.description}</p>
              <ul className={index_module_css_1.default.pathItems}>
                {path.items.map(function (item, i) { return (<li key={i}>
              ...
              <span className={index_module_css_1.default.pathLink}>
                Explore
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
...
function ConceptsSection() {
    return (<section className={index_module_css_1.default.concepts}>
      <div className={index_module_css_1.default.container}>
        <div className={index_module_css_1.default.sectionHeader}>
          <span className={index_module_css_1.default.sectionBadge}>Core Concepts</span>
          <h2 className={index_module_css_1.default.sectionTitle}>Understand the Technology</h2>
          <p className={index_module_css_1.default.sectionSubtitle}>
            Deep dive into the technology powering Namada
          </p>
        </div>
        <div className={index_module_css_1.default.conceptsGrid}>
          {concepts.map(function (concept, idx) { return (<Link_1.default key={idx} to={concept.link} className={index_module_css_1.default.conceptCard}>
              <h3 className={index_module_css_1.default.conceptTitle}>{concept.title}</h3>
              <p className={index_module_css_1.default.conceptDescription}>{concept.description}</p>
              <span className={index_module_css_1.default.conceptLink}>
                Learn more
...
function ContributeSection() {
    return (<section className={index_module_css_1.default.contribute}>
      <div className={index_module_css_1.default.container}>
        <div className={index_module_css_1.default.contributeContent}>
          <div className={index_module_css_1.default.sectionHeader}>
            <h2 className={index_module_css_1.default.sectionTitle}>Contribute to NamWiki</h2>
            <p className={index_module_css_1.default.contributeText}>
              NamWiki is open source and community-driven. Write guides, 
              translate content, or improve documentation.
            </p>
          </div>
          <div className={index_module_css_1.default.contributeOptions}>
            <div className={index_module_css_1.default.contributeOption}>
              <div className={index_module_css_1.default.optionIconWrap}>
                <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
          ...
          <Link_1.default className={index_module_css_1.default.buttonPrimary} to="/docs/contributing/how-to-contribute">
            How to Contribute
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
              <path d="M4 10H16M16 10L11 5M16 10L11 15" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
...
function CommunitySection() {
    return (<section className={index_module_css_1.default.community}>
      <div className={index_module_css_1.default.container}>
        <div className={index_module_css_1.default.sectionHeader}>
          <h2 className={index_module_css_1.default.sectionTitle}>Join the Community</h2>
          <p className={index_module_css_1.default.sectionSubtitle}>Connect with the Namada community</p>
        </div>
        <div className={index_module_css_1.default.socialLinks}>
          {socialLinks.map(function (social, idx) { return (<a key={idx} href={social.url} className={index_module_css_1.default.socialLink} target="_blank" rel="noopener noreferrer">
...
function Home() {
    ...
    return (<Layout_1.default title="Learn Namada" description="NamWiki - Community-driven education hub for Namada blockchain. Learn about MASP, shielded transactions, staking, and more.">
      <main>
        <HeroSection />
